...
(async()=>{
  ...
  try{
    ...
    await page.locator('#ko-lesson-8.active').waitFor();assert.equal(await page.locator('#koStatCompleted').textContent(),'0/13');
    ...
    await page.locator('[data-ko8-complete]').click();assert.equal(await page.locator('#koStatCompleted').textContent(),'1/13');
