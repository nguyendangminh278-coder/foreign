...
(async()=>{
  ...
  try{
    ...
    await page.locator('#ko-lesson-9.active').waitFor();assert.equal(await page.locator('#koStatCompleted').textContent(),'0/15');
    ...
    await page.locator('[data-ko9-complete]').click();assert.equal(await page.locator('#koStatCompleted').textContent(),'1/15');
